...
const DEFAULT_PROMOTIONS = Object.freeze([
  {
    ...
    description: 'Al registrarte por primera vez se acredita una bonificacion equivalente a tu primer garrafon completo.',
    kind: 'welcome',
    sortOrder: 1,
    isActive: true,
    config: {
  ...
  },
  {
    ...
    description: 'Recarga $100 y recibe $110, recarga $200 y recibe $230, recarga $500 y recibe $580.',
    kind: 'topup',
    sortOrder: 2,
    isActive: true,
    config: {
  ...
  },
  {
    ...
    description: 'Hasta 5 garrafones recibes $2 por G, hasta 10 garrafones recibes $3 por G y arriba de 10 recibes $4 por G.',
    kind: 'cashback',
    sortOrder: 3,
    isActive: true,
    config: {
  ...
  },
  {
    ...
    description: '0-199 puntos sin beneficio, 200 puntos 5% de saldo extra, 500 puntos 10%, 1000 puntos 20%.',
    kind: 'points',
    sortOrder: 4,
    isActive: true,
    config: {
